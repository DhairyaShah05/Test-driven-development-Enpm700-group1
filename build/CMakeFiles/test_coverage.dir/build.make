...
CMakeFiles/test_coverage:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Resetting code coverage counters to zero."
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "Processing code coverage counters and generating report."
	/usr/bin/lcov --gcov-tool /usr/bin/gcov -directory . -b /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2 --zerocounters
	/usr/bin/lcov --gcov-tool /usr/bin/gcov -c -i -d . -b /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2 -o test_coverage.base
	ctest
	/usr/bin/lcov --gcov-tool /usr/bin/gcov --directory . -b /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2 --capture --output-file test_coverage.capture
	/usr/bin/lcov --gcov-tool /usr/bin/gcov -a test_coverage.base -a test_coverage.capture --output-file test_coverage.total
	/usr/bin/lcov --gcov-tool /usr/bin/gcov --remove test_coverage.total /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2/app/main.cpp "/home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2/*gtest*" "/usr/include/*" /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2/build --output-file test_coverage.info
...
test_coverage: CMakeFiles/test_coverage.dir/build.make
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold " /home/dhairya/UMD/enpm_700/group_project/cpp-boilerplate-v2/build/test_coverage/index.html"
.PHONY : test_coverage
